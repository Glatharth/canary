...
void LuaEnums::initBosstiaryEnums(lua_State* L) {
	registerEnumClass(L, BosstiaryRarity_t::RARITY_BANE);
	registerEnumClass(L, BosstiaryRarity_t::RARITY_ARCHFOE);
	registerEnumClass(L, BosstiaryRarity_t::RARITY_NEMESIS);
}
